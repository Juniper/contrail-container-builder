...
function wait_vrouter_match_agent_build_version() {
    ...
    wait_cmd_success match_build_and_avail_vrouter_vers 10 30
}
...
function init_vhost0() {
    ...
    wait_vrouter_match_agent_build_version || {
        echo "WARNING: agent and vrouter module versions are different"
    }
