...
ANALYTICSDB_CASSANDRA_STORAGE_PORT=${ANALYTICSDB_CASSANDRA_STORAGE_PORT:-7000}
...
RABBITMQ_ARB_PORT_2=${RABBITMQ_ARB_PORT_2:-25672}
RABBITMQ_ARB_PORT_3=${RABBITMQ_ARB_PORT_3:-5672}
...
CONFIG_SERVICE_MONITOR_PORT=${CONFIG_SERVICE_MONITOR:-8088}
