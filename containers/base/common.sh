...
IRONIC_SERVER_IP=${KEYSTONE_AUTH_HOST:-'127.0.0.1'}
IRONIC_SERVER_PORT=${IRONIC_SERVER_PORT:-6385}
IRONIC_NOTIFICATION_MANAGER_INTROSPECT_PORT=${IRONIC_NOTIFICATION_MANAGER_INTROSPECT_PORT:-8110}
