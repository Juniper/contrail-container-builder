...
KEYSTONE_AUTH_CERTFILE=${KEYSTONE_AUTH_CERTFILE:-${SERVER_CERTFILE}}
KEYSTONE_AUTH_KEYFILE=${KEYSTONE_AUTH_KEYFILE:-${SERVER_KEYFILE}}
KEYSTONE_AUTH_CA_CERTFILE=${KEYSTONE_AUTH_CA_CERTFILE:-${SERVER_CA_CERTFILE}}
...
INTROSPECT_KEYFILE=${INTROSPECT_CERTFILE:-${SERVER_KEYFILE}}
INTROSPECT_CA_CERTFILE=${INTROSPECT_CERTFILE:-${SERVER_CA_CERTFILE}}
