...
# Tor agent options
TOR_IP=${TOR_IP:-''}
TOR_AGENT_ID=${TOR_AGENT_ID:-''}
TOR_AGENT_NAME=${TOR_AGENT_NAME:-""}
TOR_TYPE=${TOR_TYPE:-'ovs'}
TOR_OVS_PORT=${TOR_OVS_PORT:-''}
TOR_OVS_PROTOCOL=${TOR_OVS_PROTOCOL:-''}
TOR_TSN_IP=${TOR_TSN_IP:-''}
TOR_TSN_NAME=${TOR_TSN_NAME:-''}
TOR_NAME=${TOR_NAME:-''}
TOR_TUNNEL_IP=${TOR_TUNNEL_IP:-''}
TOR_VENDOR_NAME=${TOR_VENDOR_NAME:-''}
TOR_PRODUCT_NAME=${TOR_PRODUCT_NAME:-''}
TOR_HTTP_SERVER_PORT=${TOR_HTTP_SERVER_PORT:-'9090'}
TOR_AGENT_OVS_KA=${TOR_AGENT_OVS_KA:-''}
TSN_MODE=${TSN_MODE:-False}

# Vrouter module params
VR_MPLS_LABELS=${VR_MPLS_LABELS:-5210}
VR_NEXTHOPS=${VR_NEXTHOPS:-65536}
VR_VRFS=${VR_VRFS:-5120}
VR_BRIDGE_ENTRIES=${VR_BRIDGE_ENTRIES:-262144}
VR_FLOW_ENTRIES=${VR_FLOW_ENTRIES:-524288}
