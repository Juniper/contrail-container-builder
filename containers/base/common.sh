...
DEFAULT_FLOW_EXPORT_RATE=0
DEFAULT_SAMPLE_DESTINATION="collector"
if [ -n "$XFLOW_NODE_IP" ] ; then
  DEFAULT_SAMPLE_DESTINATION="collector syslog"
  DEFAULT_FLOW_EXPORT_RATE=100
fi
SAMPLE_DESTINATION=${SAMPLE_DESTINATION:-$DEFAULT_SAMPLE_DESTINATION}
FLOW_EXPORT_RATE=${FLOW_EXPORT_RATE:-$DEFAULT_FLOW_EXPORT_RATE}
