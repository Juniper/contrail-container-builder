...
CONTROLLER_DB_NODEMGR_PORT=${CONTROLLER_DB_NODEMGR_PORT:-8103}
...
CONFIG_DB_NODEMGR_PORT=${CONFIG_DB_NODEMGR:-8112}
...
VROUTER_AGENT_IPC_PORT=${VROUTER_AGENT_IPC_PORT:-9091}
VROUTER_AGENT_NODEMGR_PORT=${VROUTER_AGENT_NODEMGR_PORT:-8102}
WEBUI_CONSOLE_PORT=${WEBUI_CONSOLE_PORT:-8080}
