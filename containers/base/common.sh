...
TSN_NODES=${TSN_NODES:-[]}
KUBERNETES_API_NODES=${KUBERNETESAPI_NODES:-${CONFIG_NODES}}
...
CONFIG_SERVERS_COMMA_DELIM=${CONFIG_SERVERS_COMMA_DELIM:-`get_server_list CONFIG ","`}
...
KUBERNETES_API_SERVERS=${KUBERNETES_API_SERVERS:-`get_server_list KUBERNETES_API ","`}
