...
CONFIG_INTROSPECT_NODES=${CONFIG_INTROSPECT_NODES:-$CONFIG_NODES}
CONTROL_NODES=${CONTROL_NODES:-${CONFIG_NODES}}
CONTROL_INTROSPECT_NODES=${CONTROL_INTROSPECT_NODES:-$CONTROL_NODES}
DNS_NODES=${DNS_NODES:-${CONTROL_NODES}}
CONFIGDB_NODES=${CONFIGDB_NODES:-${CONFIG_NODES}}
CONFIGDB_INTROSPECT_NODES=${CONFIGDB_INTROSPECT_NODES:-${CONFIGDB_NODES}}
...
ANALYTICS_INTROSPECT_NODES=${ANALYTICS_INTROSPECT_NODES:-${ANALYTICS_NODES}}
ANALYTICSDB_NODES=${ANALYTICSDB_NODES:-${ANALYTICS_NODES}}
ANALYTICSDB_INTROSPECT_NODES=${ANALYTICSDB_INTROSPECT_NODES:-${ANALYTICSDB_NODES}}
...
# Set this to True if introspect services is required to be on specific
# interface IP. The default is to listen on 0.0.0.0
SECURE_INTROSPECT=${SECURE_INTROSPECT:-False}
