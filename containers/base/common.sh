...
ANALYTICS_ALARM_ENABLED=False
ANALYTICS_SNMP_ENABLED=False
ANALYTICSDB_ENABLED=False
if [[ -n $ANALYTICS_ALARM_NODES ]] ; then
  ANALYTICS_ALARM_ENABLED=True
fi
if [[ -n $ANALYTICS_SNMP_NODES ]] ; then
  ANALYTICS_SNMP_ENABLED=True
fi
if [[ -n $ANALYTICSDB_NODES ]] ; then
