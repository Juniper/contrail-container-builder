...
WEBUI_SSL_KEY_FILE=${WEBUI_SSL_KEY_FILE:-"/usr/share/ca-certificates/contrail_webui_ssl/cs-key.pem"}
WEBUI_SSL_CERT_FILE=${WEBUI_SSL_CERT_FILE:-"/usr/share/ca-certificates/contrail_webui_ssl/cs-cert.pem"}
else
