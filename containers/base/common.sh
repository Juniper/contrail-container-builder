...
ZOOKEEPER_SSL_KEY_PASSWORD=${ZOOKEEPER_SSL_KEY_PASSWORD:-'c0ntrail123'}
ZOOKEEPER_SSL_STORE_PASSWORD=${ZOOKEEPER_SSL_STORE_PASSWORD:-'c0ntrail123'}
...
if is_enabled ${ZOOKEEPER_SSL_ENABLE} ; then
  read -r -d '' zookeeper_ssl_config << EOM || true
zookeeper_keyfile=$ZOOKEEPER_SSL_KEYFILE
zookeeper_certfile=$ZOOKEEPER_SSL_CERTFILE
zookeeper_ca_cert=$ZOOKEEPER_SSL_CACERTFILE
zookeeper_ssl_password=$ZOOKEEPER_SSL_KEY_PASSWORD
EOM
else
