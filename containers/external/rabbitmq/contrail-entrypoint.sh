...
export RABBITMQ_DIST_PORT=$((RABBITMQ_NODE_PORT+20000))
export RABBITMQ_HEARTBEAT_INTERVAL=${RABBITMQ_HEARTBEAT_INTERVAL:-10}
...
RABBITMQ_DIST_IP=`echo $RABBITMQ_NODE_IP_ADDRESS | tr '\.' ','`
export RABBITMQ_SERVER_ADDITIONAL_ERL_ARGS="-kernel inet_dist_use_interface {${RABBITMQ_DIST_IP}}"
