...
function provision() {
  ...
  echo "INFO: Provisioning cmdline: python3 /opt/contrail/utils/$script $rest_params --api_server_ip {for each node from the list: $CONFIG_NODES} --api_server_port $CONFIG_API_PORT $AUTH_PARAMS"
