...
class Json2sandeshTestCase(unittest.TestCase):
    ...
    def test_contrail_config_trace_valid_data(self):
        ...
        self._test_valid_data(valid_data=data, checked_class=ContrailConfig)
    ...
    def test_vnc_api_stats_log_valid_data(self):
        ...
        self._test_valid_data(valid_data=data, checked_class=VncApiStats)
    ...
    def test_vnc_api_config_log_valid_data(self):
        ...
        self._test_valid_data(valid_data=data, checked_class=VncApiCommon)
    ...
    def test_fabric_job_uve_valid_data(self):
        ...
        self._test_valid_data(valid_data=data,
    ...
    def test_module_cpu_state_trace_valid_data(self):
        ...
        self._test_valid_data(valid_data=data, checked_class=ModuleCpuState)
    ...
    def test_vnc_api_debug_valid_data(self):
        ...
        self._test_valid_data(valid_data=data, checked_class=VncApiDebug)
    ...
    def test_vnc_api_notice_valid_data(self):
        ...
        self._test_valid_data(valid_data=data, checked_class=VncApiNotice)
    ...
    def test_vnc_api_info_valid_data(self):
        ...
        self._test_valid_data(valid_data=data, checked_class=VncApiInfo)
    ...
    def test_vnc_api_error_valid_data(self):
        ...
        self._test_valid_data(valid_data=data, checked_class=VncApiError)
