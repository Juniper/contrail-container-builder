...
export ANALYTICS_INTROSPECT_NODES=${ANALYTICS_INTROSPECT_NODES:-$ANALYTICS_NODES}
export ANALYTICSDB_NODES=${ANALYTICSDB_NODES:-$CONTROLLER_NODES}
export ANALYTICSDB_INTROSPECT_NODES=${ANALYTICSDB_INTROSPECT_NODES:-$ANALYTICSDB_NODES}
export CONFIG_NODES=${CONFIG_NODES:-$CONTROLLER_NODES}
export CONFIG_INTROSPECT_NODES=${CONFIG_INTROSPECT_NODES:-$CONFIG_NODES}
export CONFIGDB_NODES=${CONFIGDB_NODES:-$CONFIG_NODES}
export CONFIGDB_INTROSPECT_NODES=${CONFIGDB_INTROSPECT_NODES:-$CONFIGDB_NODES}
export CONTROL_NODES=${CONTROL_NODES:-$CONFIG_NODES}
export CONTROL_INTROSPECT_NODES=${CONTROL_INTROSPECT_NODES:-$CONTROL_NODES}
