...
# Zookeeper SSL options
export ZOOKEEPER_SSL_ENABLE=${ZOOKEEPER_SSL_ENABLE:-False}
export ZOOKEEPER_SSL_CERTFILE=${ZOOKEEPER_SSL_CERTFILE:-${SERVER_CERTFILE}}
export ZOOKEEPER_SSL_KEYFILE=${ZOOKEEPER_SSL_KEYFILE:-${SERVER_KEYFILE}}
export ZOOKEEPER_SSL_CACERTFILE=${ZOOKEEPER_SSL_CACERTFILE-${SERVER_CA_CERTFILE}}
