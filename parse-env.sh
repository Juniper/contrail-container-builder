...
export OPENSTACK_SUBVERSION=${OPENSTACK_SUBVERSION:-5}
...
export GENERIC_EXTRA_RPMS=${GENERIC_EXTRA_RPMS="https://dl.fedoraproject.org/pub/epel/epel-release-latest-7.noarch.rpm"}
...
export HUGE_PAGES=${HUGE_PAGES:-1024}
...
export SERVER_CA_CERTFILE=${SERVER_CA_CERTFILE:-''}
